...
import file0 from "assets/docs/Неравенства на ЕГЭ/Неравенства.pdf";
import file1 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2020.pdf";
import file2 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2019.pdf";
import file3 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2018.pdf";
import file4 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2017.pdf";
import file5 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2016.pdf";
import file6 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2015.pdf";
import file7 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2014.pdf";
import file8 from "assets/docs/Неравенства на ЕГЭ/Неравенства 2013.pdf";


const useStyles=makeStyles(styles);

export default function FileListNeravenstvaNaEge() {
